...
if pagina_seleccionada == 'Inicio':
    ...
    De todas las personas en mi vida, mi hermano menor es quien más aprecio, porque he tenido el privilegio de verlo crecer y siempre hemos estado muy unidos.
    """
    ...
    st.markdown("<h2 style='text-align: center;'>AQUÍ EXPLICO CÓMO HACER BUCLES :D</h2>", unsafe_allow_html=True)
    ...
    st.markdown(f"<div style='text-align: center;'><a href='https://drive.google.com/file/d/1h60k2JAZz8FU6d3-e_s7CvrjeJP5lQX9/view?usp=sharing' target='_blank'><button>Ver video descargable en DRIVE</button></a></div>", unsafe_allow_html=True) 
    ...
    st.markdown("<h1 style='text-align: center;'>Gráficos que hice en el curso :p</h1>", unsafe_allow_html=True)

    # Creamos una lista de gráficos
    graficos = ['Gráfico de barras verticales: Vistas vs. Colaborador', 'Gráfico Torta Netflix', 'mapa idiomas']
